...
- HashMap 只允许一条记录的键为 null, 允许多条记录的值为 null. HashMap **线程不安全**, 多线程同时操作同一个 HashMap 可能会导致数据不一致. 
...
<img src="assets/6c8d086a-3924304.png" alt="image-20200612185919503" style="zoom:45%;" />
